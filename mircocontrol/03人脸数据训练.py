...
if __name__ == '__main__':
    ...
    #保存文件
    recognizer.write('E://code//esp32//5.7//lesson7//trainer//trainer.yml')
    #save_to_file('names.txt',names)

#出现AttributeError: module ‘cv2‘ has no attribute ‘face，就需要安装opencv-contrib-python库
#安装方法:pip install opencv-contrib-python -i http://pypi.douban.com/simple --trusted-host pypi.douban.com
